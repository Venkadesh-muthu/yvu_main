...
<head>
    ...
    <!-- plugin css -->
    <link rel="stylesheet" href="<?= base_url('admin-template/assets/vendors/ti-icons/css/themify-icons.css') ?>">
    <link rel="stylesheet" href="<?= base_url('admin-template/assets/js/select.dataTables.min.css') ?>">
    ...
    <div class="container-scroller">
      ...
      <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
          <a class="navbar-brand brand-logo me-5" href="index.html"><img src="<?= base_url('admin-template/assets/images/header-main7.png')?>" class="me-2" alt="logo" /></a>
          <a class="navbar-brand brand-logo-mini" href="index.html"><img src="<?= base_url('admin-template/assets/images/yvu150a.gif')?>" alt="logo" /></a>
        </div>
