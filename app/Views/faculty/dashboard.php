<div class="main-panel">
    ...
    <div class="row">
        ...
        <div class="row">
            ...
            <h3 class="font-weight-bold">Welcome <?php $facultyname = session()->get('faculty_name'); ?>
                    <?= $facultyname; ?></h3>
    ...
    <div class="row">
        ...
        <div class="card tale-bg">
            ...
            <img src="<?= base_url('admin-template/assets/images/dashboard/people.svg') ?>" alt="people">
