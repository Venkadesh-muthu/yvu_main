            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Add Memberships</h4>
                        <p class="card-description">Fill membership details</p>

                        <form class="row g-3" action="<?= base_url('faculty/save-membership') ?>" method="post">
                            <?= csrf_field() ?>
